...
credible_intervals <- find_beta_credible_interval(k1+k2+2, n1-k1+n2-k2+2, max_iterations = 10^3, criterion = 0.05)
highest_posterior_density <- find_beta_hpd(k1+k2+2,n1-k1+n2-k2+2,conf_range = 0.95)
