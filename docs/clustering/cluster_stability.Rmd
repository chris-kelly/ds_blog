...
However, what would we do if the ground truth labels don't exist?
...
We can capture this with a plot of the convex hull of cluster boundaries where observations ended up in the same cluster > x% of the time:
